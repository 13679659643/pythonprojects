...
if __name__ == "__main__":
    redis_client = RedisClient(host='192.168.0.201', port=16379, db=5, password='DoocnProRedis201.')
    # RedisKeys.JD_LOGIN_KEY.value -- > domestic-multi-channel-Login:jd:jd_vcp:login
    aa = redis_client.get_auth_cookie(RedisKeys.JD_LOGIN_KEY.value)
