...
# crawler-multi-channel-jd-jm-refundfacetdto
ods_cd_sl_jd_jm_refundamt_db_table = "ods_prod.ods_cd_sl_jd_jm_refundamt_i_d"

ods_cd_sl_jd_jm_refundamt_i_d = """
CREATE TABLE IF NOT EXISTS ods_prod.`ods_cd_sl_jd_jm_refundamt_i_d`
(
    `dt`                       varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '采集日期',
    `account`                  varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '账户名',
    `afsServiceId`             varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '服务单号',
    `orderId`                  varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '订单编号',
    `afsApplyTime`             varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '售后服务申请时间',
    `refundAmount`             varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '退款金额',
    `wareNum`                   varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '申请退款数量',
    `refundStatusName`         varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '退款状态',
    `customerExpectName`       varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '客户期望',
    `afsReasons`               varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '客户退货理由',
    `serviceOrderSubStateName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '售后状态',
    PRIMARY KEY (`dt`, `account`, `afsServiceId`) /*T![clustered_index] CLUSTERED */
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='朗盟京麦-自主售后-退款金额数据-辜涛'
    partition by key (dt) partitions 3;
"""

ods_cd_sl_jd_jm_refundamt_i_d_field_list = [
    "dt",
    "account",
    "afsServiceId",
    "orderId",
